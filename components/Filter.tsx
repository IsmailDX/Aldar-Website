...
const Filter = () => {
  ...
  useEffect(() => {
    ...
    if (properties.length > 0) {
      // If properties are already fetched, directly call fetchData
      fetchData();
    }
  ...
  return (
    <div
      className={`${
        openFilterPage ? "h-[100dvh] relative" : "h-full"
      } overflow-hidden`}
    >
      ...
      <div className="w-full flex flex-col justify-center py-20 2xl:max-w-[1200px] lg:max-w-[1000px] md:max-w-[700px] mx-auto space-y-10 overflow-hidden">
        ...
        {isFetching && (
          <div className="flex flex-col items-center space-y-3 px-5">
            <h1 className="font-RobotoBold text-[22px] animate-pulse">
              Loading Properties
            </h1>
            <div className="flex space-x-2 justify-center items-center bg-black dark:invert animate-pulse">
            ...
            <AnimatedContainer
              initialClassName="opacity-0"
              transitionClassName="transition-all duration-700 delay-[10s]"
              whileInViewClassName="opacity-100"
              className=""
              once
            >
              <h1 className="font-RobotoBold text-[15px] animate-pulse">
        ...
        {/* Display "no properties" message when there are no properties */}
        {!isFetching && filteredProperties.length === 0 && (
