        ...
        <main className="relative" key={property.id}>
          ...
          transition-all duration-300"
            ...
            <div className="mb-14 mdplus:pt-10 pt-20 w-full relative overflow-hidden">
              ...
              <AnimatedContainer
                initialClassName="md:translate-x-[-600px] translate-x-[-400px]"
                transitionClassName="transition-all duration-700"
            ...
            <div className="w-full flex flex-col items-center">
              <div className="w-full 2xl:max-w-6xl lg:max-w-5xl lg:px-0 px-10">
                <AnimatedContainer
                  initialClassName="translate-y-[-90px] opacity-0"
                  transitionClassName="transition-all duration-700"
                ...
                <div className="grid lg:grid-cols-3 py-3 grid-cols-1">
                  <div className="col-span-2 lg:w-[80%] w-full">
                    <AnimatedContainer
                      initialClassName="translate-x-[-90px] opacity-0"
                      transitionClassName="transition-all duration-700"
                    ...
                    <AnimatedContainer
                      initialClassName="translate-x-[-300px] opacity-0"
                      transitionClassName="transition-all duration-700"
                      whileInViewClassName="translate-x-0 opacity-100"
                      className=""
                      once
                    >
                      <div className="py-12 w-full">
                        ...
                        <p className="font-semibold text-gray-700 md:text-[18px] text-[16px] pt-2">
                          ...
                          sustainable community that embraces nature and the
                          best of two cities. With 2,100 maisonettes, townhouses
                          and villas already built and occupied, another 14,000
                          are set to be handed over in April 2021.
                        </p>
                  ...
                  <AnimatedContainer
                    initialClassName="translate-y-[300px] opacity-0"
                    transitionClassName="transition-all duration-700"
                    whileInViewClassName="translate-y-0 opacity-100"
                    className=""
                    once
