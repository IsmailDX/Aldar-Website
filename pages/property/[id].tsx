                ...
                <div className="col-span-2 lg:w-[80%] w-full">
                  ...
                  <div className="py-12 w-full">
                    ...
                    <p className="font-semibold text-gray-700 md:text-[18px] text-[16px] pt-2">
                      In Abu Dhabi but located close to the border of Dubai and
                      minutes from Expo 2020 Dubai, Al ghadeer is a sustainable
                      community that embraces nature and the best of two cities.
                      With 2,100 maisonettes, townhouses and villas already
                      built and occupied, another 14,000 are set to be handed
                      over in April 2021.
                    </p>
